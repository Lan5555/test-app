  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={`relative flex w-full max-w-5xl flex-col border border-white/10 bg-[#070c10]/95 shadow-2xl backdrop-blur-md lg:flex-row ${
      ...
      >
        ...
        <button
          ...
          onClick={close}
          aria-label="Close"
          className="absolute right-4 top-4 z-10 rounded-md p-1.5 text-white/40 transition hover:bg-white/10 hover:text-white"
        >
          <X className="size-4" />
        </button>
        ...
        {/* -------------------------------------------------------- */}
        <div className="w-full shrink-0 border-b border-white/10 p-5 lg:w-80 lg:border-b-0 lg:border-r">
          <p className="text-[10px] font-black uppercase tracking-[0.4em] text-cyan-200/50">
            The Chronicle
          </p>
          <h3 className="mt-1 text-lg font-black uppercase tracking-wider">
            Chapter Select
          </h3>

          <div className="mt-5 flex max-h-[70vh] flex-col gap-2 overflow-y-auto pr-1">
            {CHAPTERS.map((c) => {
              const Icon = c.icon;
              ...
              return (
                <button
                  ...
                  className={`group relative flex items-start gap-3 border px-4 py-3 text-left transition ${
                    active
                ...
                >
                  ...
                  <span className="min-w-0 flex-1">
                    ...
                    <span
                      className={`mt-0.5 block truncate text-sm font-black uppercase tracking-widest transition ${
                        isLocked
                          ? "text-white/30"
                          : active
                            ? "text-white"
        ...
        <div className="relative flex-1 p-6 sm:p-8">
          ...
          <div className="flex items-start gap-5">
            <div
              className="flex size-16 shrink-0 items-center justify-center border"
              style={{
            ...
            >
              <SelectedIcon
                className={`size-8 ${selected.accent}`}
          ...
          {selected.status === "completed" ? (
            <p className="mt-6 border-l-2 border-emerald-300/40 pl-4 text-xs italic text-emerald-200/70">
          ...
          {/* Locked note */}
          {locked ? (
            <p className="mt-6 border-l-2 border-white/10 pl-4 text-xs italic text-white/35">
          ...
          <div className="mt-8 flex flex-wrap items-center justify-end gap-3 border-t border-white/10 pt-5">
            ...
            <button
              ...
              className={`rounded-xl px-6 py-2.5 text-xs font-black uppercase tracking-widest transition ${
                locked
